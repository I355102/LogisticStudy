/*global history */
sap.ui.define([
		"CaseStudy/Operator/controller/BaseController",
		...
		"sap/ui/Device",
		"CaseStudy/Operator/model/formatter"
	], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("CaseStudy.Operator.controller.Master", {
			...
			_showDetailAssign : function (oItem) {
				...
				// set the layout property of FCL control to show two columns
				this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
				this.getRouter().navTo("objectAssign", {
					objectId : oItem.getBindingContext().getProperty("Id")
				}, bReplace);
			},
