...
sap.ui.define([
	...
	], function (BaseController, JSONModel, formatter,Button, Dialog,MessageToast,Label,Text,TextArea) {
		"use strict";

		return BaseController.extend("CaseStudy.Logistics.controller.Manager.Detail", {
			...
			var dialog = new Dialog({
				title: 'REJECT',
				type: 'Message',
				content: new Text({ text: "Are you sure you want to accept the leave" }),
			...
			var dialog = new Dialog({
				...
				type: 'Message',
				content: [
					new Label({ text: "Are you sure you want to accept the leave", labelFor: 'ACCEPTDialogTextarea'}),
