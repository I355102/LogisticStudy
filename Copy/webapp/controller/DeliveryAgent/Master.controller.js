...
sap.ui.define([
	...
	], function (BaseController,JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter, Fragment) {
		"use strict";

		return BaseController.extend("CaseStudy.Logistics.controller.DeliveryAgent.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("DA.DeliveryAgent.view.ViewSettingsDialog", this);
			...
			if (!this._oPopover) {
				this._oPopover = sap.ui.xmlfragment("CaseStudy.Logistics.Fragment.Popover", this);
