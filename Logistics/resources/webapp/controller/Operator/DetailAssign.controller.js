...
sap.ui.define([
		...
		return BaseController.extend("CaseStudy.Logistics.controller.Operator.DetailAssign", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("operatorobjectAssign").attachPatternMatched(this._onObjectMatched, this);
