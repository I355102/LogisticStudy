...
sap.ui.define([
		...
		return BaseController.extend("CaseStudy.Logistics.controller.Operator.First", {

			formatter: formatter,

			onInit : function () {
				//create ODATA service to retrieve REGIONS
...
//				this.getRouter().getRoute("First").attachPatternMatched(this._onMasterMatched, this);
//				this.getRouter().attachBypassed(this.onBypassed, this);
		...
		onNavBack : function() {
			...
			if (sPreviousHash !== undefined) {
				...
				var bReplace = true;
				this.getRouter().navTo("First", {}, bReplace);
			}},
			...
			//	this.getModel("appView").setProperty("/layout", "OneColumn");
				this.getRouter().navTo("operatormaster", {
					R_Id : oItem.getBindingContext().getProperty("R_Id")
				}, bReplace);
			},
